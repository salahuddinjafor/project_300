	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
							<!-- work order  --> 
						<?php
							$slq="SELECT * FROM assignwork_tbl";
							...
							if($result->num_rows>0){
								...
								while($row=$result->fetch_assoc()){
									...
									<button class="btn btn-warning" name="view" value="View" type="submit">View</button>	</form>
									';
									echo '<td>	
							...
							if(isset($_POST['delete'])){
								$sql="DELETE FROM assignwork_tbl WHERE requester_id={$_POST['id']}";
